  ...
  <div className={
    ...
    {SOCIAL_ITEMS.map(({ href, title, Icon }) => (
      <a
        ...
        title={title}
        className={
          'transition-all hover:text-black dark:hover:text-stone-200 ' +
...
const MobileProfileBlock = ({ time }: { time: WorldTime }) => (
  <div className="md:hidden w-full pb-5">
    <div className="flex items-start gap-3">
      <div className="w-[27vw] max-w-[118px] min-w-[88px] flex-shrink-0">
        <img
          src={PROFILE.avatar}
      ...
      <div className="newsreader flex-1 min-w-0 pt-0.5">
        <h3 className="newsreader text-[16px] leading-[1.2] text-stone-950 dark:text-stone-100 truncate">{PROFILE.name}</h3>
        <p className="mt-1 text-[12px] leading-[1.3] text-stone-700 dark:text-stone-300 truncate">University of Bristol</p>
        <SocialLinks compact />
        <div className="mt-2.5 pt-2 text-[10px] text-stone-700 dark:text-stone-300 leading-[1.35]">
...
export const IntelligenceSection = () => (
  <div className="space-y-6">
    <div className="flex items-center space-x-4">
      <h4 className="text-[11px] font-medium text-stone-500 dark:text-stone-400 uppercase tracking-[0.06em]">Intelligence</h4>
    </div>
...
export const ResearchSection = () => (
  <section className="pt-2 md:pt-4 flex flex-col md:flex-row gap-6 md:gap-24 lg:gap-32">
    ...
    <div className="flex-grow grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-8">
      {PROFICIENCY.map((group, i) => (
        <div key={i} className="space-y-6">
          <h4 className="text-[11px] font-medium text-stone-500 dark:text-stone-400 uppercase pb-2 mb-4 tracking-[0.06em]">
            {group.category}
          </h4>

...
export const ArticleRow = ({ onClick, title, meta, variant = 'index', children }: ArticleRowProps) => {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full text-left bg-transparent cursor-pointer border-t-[0.5px] border-neutral-200 dark:border-neutral-700 flex flex-col gap-4 group transition-colors hover:opacity-70 ${isEssay ? 'py-12 md:py-14' : 'py-9 md:py-10'}`}
    >
